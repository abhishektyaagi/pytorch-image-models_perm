...
args = Namespace(
        ...
        checkpointA='/localdisk/Abhishek/pytorch-image-models_perm/output/train/deit-tiny-permDiagI100_patchLinear_maskPerm_0.95_48/model_best.pth.tar',
        modelB='deit_tiny_patch16_224',
        checkpointB='/localdisk/Abhishek/pytorch-image-models_perm/output/train/deit-tiny-permkmI100_patchLinear_permStruc_0.80/model_best.pth.tar',
